...
data class Command(
    ...
    companion object {
        ...
        fun fromLine(x1: Float, y1: Float, x2: Float, y2: Float): Command {
            return Command(TYPE_C, floatArrayOf(x1, y1, x2, y2, x2, y2))
        }
         ...
         */
        fun fromCoordinates(type: Int, coordinates: FloatArray): Command {
        ...
        fun fromPoints(type: Int, vararg points: PointF): Command {
            return Command(type, points.toList().toFloatArray())
        }
        ...
        internal fun generateCoordinates(commandString: String): FloatArray {
            ...
            val coordinates =
                parseIntsAndDoubles(commandString.subSequence(1, commandString.length).toString())
