...
import com.chuntian.data.model.*
...
object DemoDataProvider {
    ...
    val item = Item(
        ...
        subtitle = "Very awesome list item has very awesome subtitle. This is bit long",
        R.drawable.food6
    )

    val tweet = Tweet(
        id = 1,
        text = "Jetpack compose is the next thing for android. Declarative UI is the way to go for all screens.",
        author = "The Verge",
        handle = "@verge",
        time = "12m",
        authorImageId =R.drawable.food1,
        likesCount = 100,
        commentsCount = 12,
        retweetCount = 15,
    ...
    val demoScreenListItems = DemoItems.values().toList()
