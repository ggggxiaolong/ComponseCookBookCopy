...
object Versions {
    ...
    const val activityCompose = "1.7.0-alpha01"
    const val pagingCompose = "1.0.0-alpha16"
    const val navCompose = "2.6.0-alpha02"
    const val constraintLayoutCompose = "1.1.0-alpha04"
    const val fontAwesomeCompose = "1.1.0"
    const val accompanistCoil = "0.15.0"
    const val coilCompose = "2.2.2"
    const val kotlin = "1.7.20"
    const val coroutines = "1.6.4"
    const val androidLifecycleGrouped = "2.6.0-alpha02"
